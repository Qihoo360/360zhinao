...
# Copyright 2025 The Zhinao team.
#
...
class ZhinaoModel(nn.Module):
    ...
    def __init__(self,
                 *,
                 ...
                 prefix: str = "",
                 layer_type: type[nn.Module] = ZhinaoDecoderLayer):
        super().__init__()
...
class ZhinaoForCausalLM(nn.Module, SupportsLoRA, SupportsPP):
    ...
    def _init_model(self,
                    ...
                    prefix: str = "",
                    layer_type: type[nn.Module] = ZhinaoDecoderLayer):
        return ZhinaoModel(vllm_config=vllm_config,
                          prefix=prefix,
                          layer_type=layer_type)
