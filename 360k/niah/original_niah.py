...
class LLMNeedleHaystackTester:
    ...
    def evaluate_and_log(self, context_length, depth_percent, model):
        ...
        if self.save_results:
            # Save the context to file for retesting
            result_path = f'results/{self.model_name.replace(".", "_")}_en'
    ...
    def result_exists(self, context_length, depth_percent):
        ...
        results_dir = 'results/' + self.model_name.replace(".", "_") + '_en'
...
if __name__ == "__main__":
    ...
    url_list = [#"http://11.73.244.87:7083/generate",
    ...
    ht = LLMNeedleHaystackTester(Qwen_path=tokenizer_path,
                                ...
                                #  retrieval_question="What is the most fun thing to do in San Francisco based on above document?",
                                #  further_instruct="Don't give information outside the document.",
